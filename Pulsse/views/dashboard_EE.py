...
dashboard_blueprint_EE = Blueprint('/dashboard', __name__, url_prefix='/dashboard')

@dashboard_blueprint_EE.route('/dashboard_data_EE', methods=['GET'])
# @jwt_required()
def dashboard_data_EE():
